...
--
-- Host: localhost
-- Generation Time: Jul 04, 2022 at 11:40 AM
...
CREATE TABLE `category` (
  ...
  `parent_id` bigint DEFAULT '0' COMMENT 'This field stores parent category for this category',
...
(22, 'test1', 56, 1, 'test', 53, 'mumbai', '4011107', '', 1, '2022-07-04 11:15:45'),
...
CREATE TABLE `locations` (
  ...
  `loc_status` smallint DEFAULT NULL,
...
CREATE TABLE `setting` (
  ...
  `setting_value` text,
  `setting_status` smallint DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `locations`
  MODIFY `loc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
