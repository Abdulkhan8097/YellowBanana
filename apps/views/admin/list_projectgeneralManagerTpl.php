         ...
         <div class="col-md-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Project General Managers</h3>
                  <div class="card-options">
                     <a href="<?php echo site_url('adminDashboard/add_projectgeneralManager') ?>" id="add__new__list" class="btn btn-sm btn-success " ><i class="fa fa-plus"></i> Add New Project General Manager</a>
                  </div>              
               </div>
