            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Edit Area Manager</div>                       
                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name='parentid' >
                                                            ...
                                                            <?php 
                                                                for($i=0;$i<sizeof($general_manager);$i++)
                                                                {
                                                                    $selected = $general_manager[$i]['id'] == $userdata[0]['parent_id'] ? 'selected' : '';
                                                                    ?>
                                                                    <option value="<?php echo $general_manager[$i]['id'] ;?>" <?php echo $selected ;?>><?php echo ucwords($general_manager[$i]['fname'])." ".ucwords($general_manager[$i]['lname']) ;?></option>
                                                                    <?php
                                                                }
                                                            ?>
                                                        </select>
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $('#cancel').click(function(){
            window.location.href = "<?php echo site_url('adminDashboard/list_areaManager'); ?>";
      });
