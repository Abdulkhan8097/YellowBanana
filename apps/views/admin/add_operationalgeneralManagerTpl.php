...
<div class="app-content bg-img my-3 my-md-5">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Add Operational General Manager</div>                       
                    </div>
                        ...
                        <!-- <div class="col-lg-8"> -->
                            <form class="card" id='add_member_form' method='post' action="<?php echo site_url('adminDashboard/save_member'); ?>" enctype='multipart/form-data'>            
                                ...
                                <div class="card-footer text-right">
                                    <input type = 'hidden' name='usertype' value='operational_general_manager'>                            
    ...
    <script type="text/javascript">
      ...
      $('#add_member_form').validate({
       rules: {
        ...
        email :
        {
         ...
         email:true,
         remote:
         {url: "<?php echo site_url('adminDashboard/checkEmailExist');?>",type: "post"}
     }, 
     ...
     mobile : {
         ...
         maxlength:10,
         remote:
         {url: "<?php echo site_url('adminDashboard/checkMobileNo');?>",type: "post"}
     }
 },   
 messages:{
 ...
 mobile : {
     ...
     maxlength:"Please enter valid mobile number"
      ...
      $('#cancel').click(function(){
        window.location.href = "<?php echo site_url('adminDashboard/list_generalManager'); ?>";
    });
