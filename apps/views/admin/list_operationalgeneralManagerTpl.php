         ...
         <div class="col-md-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Operational General Managers</h3>
                  <div class="card-options">
                     <a href="<?php echo site_url('adminDashboard/add_operationalgeneralManager') ?>" id="add__new__list" class="btn btn-sm btn-success " ><i class="fa fa-plus"></i> Add New operational General Manager</a>
                  </div>              
               </div>
               ...
               <div class="card-body">
                  ...
                  <form action="" id="add_ogm" method="get" class="form-inline">
                     ...
                     <a href="<?php echo site_url('adminDashboard/list_generalManager'); ?>" class="btn btn-primary btn-sm" style="margin-left:10px">Refresh</a>
                  </form>
                  <br/>
               ...
               if($pagination['haveToPaginate'])
                  { ?>
                   <?php $this->load->view('admin/_paging',array('paginate'=>$pagination,'siteurl'=>'/adminDashboard/list_generalManager','varExtra'=>$filtres)); ?>
                   <?php 
                } 
                ?>                     
             </div>
