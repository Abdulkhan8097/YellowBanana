            ...
            <div class="card">
               <div class="card-header">
                  ...
                  <div class="card-options">
                     <a href="<?php echo site_url('adminDashboard/add_Accountant') ?>" id="add__new__list" class="btn btn-sm btn-success " ><i class="fa fa-plus"></i> Add New Accountant</a>
                  </div>              
               </div>
               ...
               <div class="card-body">
                  ...
                  <form action="" method="get" class="form-inline">
                     ...
                     <a href="<?php echo site_url('adminDashboard/list_Accountant'); ?>" class="btn btn-primary btn-sm" style="margin-left:10px">Refresh</a>
                  </form>
                  <br/>
                  ...
                  <?php 
                     ...
                     { ?>
                       <?php $this->load->view('admin/_paging',array('paginate'=>$pagination,'siteurl'=>'/adminDashboard/list_Accountant','varExtra'=>$filtres)); ?>
                     <?php 
                     } 
                  ?>                      
               </div>
