            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Add Area Manager</div>                       
                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name='parentid' >
                                                            ...
                                                            <?php 
                                                                ...
                                                                {
                                                                    ?>
                                                                    <option value="<?php echo $general_manager[$i]['id'] ;?>"><?php echo ucwords($general_manager[$i]['fname'])." ".ucwords($general_manager[$i]['lname']) ;?></option>
                                                                    <?php
                                                                }
                                                            ?>
                                                        </select>
   ...
   $(document).ready(function(){
      ...
      $('#add_member_form').validate({
         ...
         messages:{
            ...
            parentid:{
               required:"Please select general manager"
            },
            location:{
