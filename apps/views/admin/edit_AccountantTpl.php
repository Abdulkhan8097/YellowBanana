            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Edit Accountant</div>                       
                    </div>
                        ...
                        <div class="col-auto">
                           <!-- <span class="avatar brround avatar-xl cover-image" > -->
                              <?php
                                 ...
                                 {
                                    ?>
                                    <img class="img-responsive" src="<?php echo base_url();?>/assets/upload/admin/accountant/<?php echo $userdata[0]['profile_picture'] ;?>"/>
                                    <?php
                                 }
                                 else
                                 {
                                    ?>
                                    <img class="img-responsive" src="<?php echo base_url();?>/assets/images/default.png"/>
                                    <?php
                                 }
                              ?>
