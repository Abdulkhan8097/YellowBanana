...
if ( ! function_exists('create_captcha'))
{
	...
	function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
	{
		...
		//  Assign colors
		// -----------------------------------
		$bg_color	= imagecolorallocate($im, 211, 211, 211);
		$border_color	= imagecolorallocate($im, 000, 000, 000);
		$text_color	= imagecolorallocate($im, 000, 000, 000);
		$grid_color	= imagecolorallocate($im, 211, 211, 211);
		$shadow_color	= imagecolorallocate($im, 211, 211, 211);
